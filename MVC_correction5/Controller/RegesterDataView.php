<?php
  ...
  if (isset($_POST["Regester"])) {
    ...
    $UserDataObj = new Model\UserData();
    ...
    if($i == 0) {
      if($Password == $RePassword) {
        ...
        $data = $UserDataObj -> UserCredentialEntry($FirstName,$LastName,$Address,$PhoneNumber,$EmailAddress, $UserName,$Password,$file_store,$dataTime); 
        if($data == 1){

          //in login page redirect
