<?php
  ...
  <body>  
    <div class = "container">
      <div class = "Header">
        <h1> MY BLOG PAGE </h1>
        <a href = "http://www.example.com/addpost"><button> Add Blog </button></a>
        <a href = "http://www.example.com/logout "><button> Log out </button></a>
        <a href = 'http://www.example.com/homepageviewblog '><button> Back </button></a>
      </div>
        ...
        if($blogData) {
          foreach($blogData as $key => $value) {?>
            ...
            foreach($personaldata as $key1 => $value1) {
              ...
              <form action = "http://www.example.com/test" method="POST" enctype="multipart/form-data">
