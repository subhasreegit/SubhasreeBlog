      ...
      <div class = "container">
        <div class = "upper">
          <div class = " Header">
            ...
            <a href = "../index.php/login"><button> Sign in </button></a>
            <a href = "../index.php/signup"><button> Sign up </button></a>
          </div>
          <div class = "heading">
          ...
          foreach($blogData as $key => $value) { ?>
            <div class = "Content">
              ...
              foreach($personaldata as $key1 => $value1) {
                ...
                <form action = "../index.php/fullContentShow" method = "POST">
