...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="View/SignUpPageDesign.css">
    ...
    <body>
      <div class="Container">
        <div class="Header">
          ...
          <div class="Details">
            <form action="RegesterDataView.php" method="POST" enctype="multipart/form-data">
              ...
              <input type="submit" name="Regester" id="Regester">
            </form>
        </div>
        <div class="Footer">
